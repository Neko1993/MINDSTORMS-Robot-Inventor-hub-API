# import hub.battery, hub.bluetooth, hub.display, hub.button, hub.motion
...
class BT_VCP:
    ...
    def write(buf: bytes) -> int:
        pass
    def recv(data: Union[int, bytearray], timeout=5000) -> int:
        pass
